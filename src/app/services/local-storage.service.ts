...
export class LocalStorageService {
  ...
  saveGame(game: Game, listType: ListType) {
    let gameList: Game[] = JSON.parse(<any>window.localStorage.getItem(listType.valueOf()));
    if (!gameList) {
      gameList = [game];
    } else {
    ...
    const parsedUpdateList = JSON.parse(<any>window.localStorage.getItem(listType.valueOf()));
  ...
  getGameList(listType: ListType) {
    let list = JSON.parse(<any>window.localStorage.getItem(listType.valueOf()));
